...
CommuterWidget::commutertype CommuterWidget::gettype()
{
    return typetick;
};


void CommuterWidget::setnormal()
{
    is_reversed = false;
};


void CommuterWidget::setreversed()
{
    is_reversed = true;
};


bool CommuterWidget::isreversed()
{
    return is_reversed;
};
