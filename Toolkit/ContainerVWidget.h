...
///
/// The following simple example demonstrate how to use the ContainerVWidget controls.
///
/// ### Examples of usage:
/// ~~~~~~~~~~~~~~~~~~~~~~.cpp
...
/// ~~~~~~~~~~~~~~~~~~~~~~
/// ~~~~~~~~~~~~~~~~~~~~~~.cpp
/// CommuterWidget* myContainerV = new ContainerVWidget( "I am a CheckBox", 10, 50, 100, 15, parent );        // Full constructor
/// ~~~~~~~~~~~~~~~~~~~~~~
class ContainerVWidget : public Widget
{
    public:
        ...
        /// @returns Nothing
        /// @see Widget()
        ContainerVWidget() { widgettype = (char*) "ContainerV"; };
        ...
        ContainerVWidget( char *l, int x, int y, int w, int h, Widget *p ) : Widget( l, x, y, w, h, p ) { widgettype = (char*) "ContainerV"; };
